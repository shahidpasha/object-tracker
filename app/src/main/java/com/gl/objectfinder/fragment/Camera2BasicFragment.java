...
package com.gl.objectfinder.fragment;
...
public class Camera2BasicFragment extends Fragment
    ...
    //Reference to class implementing onpicturetaken callback
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCallBack = (CameraActivity)getActivity();
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                    ...
                    unlockFocus();
                    mCallBack.OnPictureTaken(mFile);
    ...
    /**
     * Interface to be implemented in the activity to get notified on picture taken
     */
